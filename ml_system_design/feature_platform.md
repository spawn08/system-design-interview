...
|----------|--------------|
| **Feast / Tecton docs** | Patterns for registry + offline/online stores |
| **Flink windowing** | Event-time, watermarks, state |
| **Data validation (Great Expectations / Deequ)** | Automated quality gates in batch paths |
